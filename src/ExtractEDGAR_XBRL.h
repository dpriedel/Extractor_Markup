...
std::optional<EE::SEC_Header_fields> FilterFiles(const std::string& file_content, std::string_view form_type, const int MAX_FILES, std::atomic<int>& files_processed);
