...
class XLS_Sheet
{
   ...
   public:
    ...
    bool operator==(const XLS_Sheet& rhs) const { return content_ == rhs.content_ && sheet_name_mc_ == rhs.sheet_name_mc_; }
...
class XLS_File::sheet_itor
{
   ...
   public:
    ...
    sheet_itor& operator++();
    sheet_itor operator++(int)
    {
        sheet_itor retval = *this;
        ++(*this);
        return retval;
    }
    ...
    bool operator==(const sheet_itor& rhs) const { return sheet_list_ == rhs.sheet_list_ && sheet_name_ == rhs.sheet_name_; }
...
class XLS_Sheet::row_itor
{
   ...
   public:
    ...
    row_itor& operator++();
    row_itor operator++(int)
    {
        row_itor retval = *this;
        ++(*this);
        return retval;
    }
    ...
    bool operator==(const row_itor& rhs) const { return current_sheet_ == rhs.current_sheet_ && current_row_ == rhs.current_row_; }
